...
export const TOOL_DEFINITIONS = [
    ...
    {
        name: "evm_transfer",
        description: "Transfer native tokens or USDC on Ethereum, Base, Arbitrum, Polygon, Monad, HyperEVM, or their testnets. Supports native (ETH/MON/POL/HYPE) and USDC transfers.",
        input_schema: {
            type: "object",
            properties: {
                chain: {
    ...
    {
        name: "bridge",
        description: "Bridge tokens between different blockchains using Relay. Supports Ethereum, Base, Arbitrum, Polygon, Monad, Tempo, Solana, HyperEVM, and Hyperliquid where routes are available.",
        input_schema: {
            type: "object",
            properties: {
                sourceChain: {
        ...
        input_schema: {
            ...
            properties: {
                ...
                abstraction: {
                    ...
                    description: "Account abstraction mode for set_abstraction (default: unifiedAccount)",
                },
            },
            required: ["action"],
        },
    ...
    {
        name: "bank_onboard",
        description: "Start or resume banking onboarding. Returns a KYC verification link until internal KYC is approved, then a bank terms URL unless the customer is already active.",
        input_schema: {
            type: "object",
            properties: {
                wallet_id: {
    ...
    {
        name: "bank_status",
        description: "Check banking onboarding, KYC, terms, and capability status.",
        input_schema: {
            type: "object",
            properties: {},
            required: [],
    ...
    {
        name: "bank_send",
        description: "Send USD from a crypto wallet to a linked external bank account by funding a bank payout with USDC.",
        input_schema: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        description: "Generate a one-time Link card credential from a saved Link payment method for a specific merchant and amount. " +
        ...
        input_schema: {
            ...
            properties: {
                link_payment_method_id: {
                    type: "string",
                    description: "Saved Link payment method id. May be either Sponge's saved method id or Link's payment method id. Defaults to the agent's default saved Link method.",
                },
                spend_request_id: {
                    type: "string",
                    description: "Existing Link spend request id returned by an approval_required response. Use after the user approves.",
                },
                amount: {
                    type: "string",
                    description: "Purchase amount as a decimal string, e.g. '49.99'. Required when creating a new spend request.",
                },
                currency: {
                    type: "string",
