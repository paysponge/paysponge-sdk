 ...
 */
export function instanceOfPostApiAmazonCheckoutRequest(value) {
    if (!('checkoutUrl' in value) || value['checkoutUrl'] === undefined)
        return false;
    return true;
}
export function PostApiAmazonCheckoutRequestFromJSON(json) {
    return PostApiAmazonCheckoutRequestFromJSONTyped(json, false);
}
export function PostApiAmazonCheckoutRequestFromJSONTyped(json, ignoreDiscriminator) {
    if (json == null) {
        return json;
    }
    return {
...
export function PostApiAmazonCheckoutRequestToJSON(json) {
    return PostApiAmazonCheckoutRequestToJSONTyped(json, false);
}
export function PostApiAmazonCheckoutRequestToJSONTyped(value, ignoreDiscriminator = false) {
    if (value == null) {
        return value;
    }
    return {
...
//# sourceMappingURL=post-api-amazon-checkout-request.js.map